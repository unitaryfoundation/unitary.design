...
## 🗓️ Participant Timeline 🗓️

> - **ASAP**: Sign up for unitaryDESIGN!
> - **February 16th**: unitaryDESIGN 2026 begins.
> - **February 27th at 5pm [AoE](https://time.is/Anywhere_on_Earth)**: Deadline to submit pull requests.
...
* PennyLane [Demos](https://pennylane.ai/qml/demonstrations) and [Codebook](https://pennylane.ai/codebook)
...
The main place that will be most helpful to you while you hack is connecting with other participants and maintainers on the [Unitary Foundation Discord](http://discord.unitary.foundation/). You can find folks from the Unitary Foundation to ask about rules, as well as maintainers of the participating projects, and other participants who might be able to lend a hand or team up (totally encouraged)!


### Find a task to dive into

Once you have found a [project]({{ '/projects/' | url }}) you want to work on, find an issue on that project you want to lend a hand on. This could be one of the special bountied issues (meaning if you submit a maintainer accepted solution for these we will send you cash), or any other issue on that repo. Pay special attention to issues tagged unitaryDESIGN as they are ones the project maintainers have flagged as particularly good for contest participants to tackle.

If you want to team up with other participants on an issue that you have found, you can make a comment on the GitHub issue. Even if you don't plan to team up, commenting on GitHub may help other participants know if someone else is working on that issue (that's fine, but depending on the issue, only one pull request may be merged to solve an issue). We ask that you not comment on more than 3-4 projects per day. This is to ensure that you are not overwhelming yourself, the maintainers, or your fellow participants. 
...
We ask that you not have more than 4 pull requests open at one time across all unitaryDESIGN projects. This is to ensure that you are not overwhelming yourself, that other participants are getting a chance to contribute, and that our maintainers are not inundated with PRs that aren’t fully complete. 
